...
import 'package:askfemi/utils/congratulations_screen.dart';
...
class _VerifyEmailScreenState extends State<VerifyEmailScreen> {
  ...
  void _resendCode() {
    if (!_isTimerActive) {
      ...
      // You can show a snackbar or message
                      ...
                      child: ElevatedButton(
                        ...
                        onPressed: () {
                          if (pinController.text.length == 6) {
                            // Add your verification logic here
                            print("Verifying code: ${pinController.text}");
                            // You can navigate to next screen or verify the code
                          } else {
                            ScaffoldMessenger.of(context).showSnackBar(
                              const SnackBar(
...
class _VerifyEmailScreenState extends State<VerifyEmailScreen> {
  ...
  void _verifyAndNavigate() {
    ...
    // For UI phase only - accept any 6-digit input and navigate
