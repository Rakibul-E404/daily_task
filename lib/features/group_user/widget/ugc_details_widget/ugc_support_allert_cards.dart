...
class UgcSupportAlertCards {
  static void show(
      BuildContext context, {
        required UgcSupportAlertType type,
...
class _SupportAlertDialog extends StatelessWidget {
  final UgcSupportAlertType type;
...
_AlertConfig _alertConfig(UgcSupportAlertType type) {
  switch (type) {
    case UgcSupportAlertType.clam:
      return _AlertConfig(
        message:
    ...
    case UgcSupportAlertType.encouraging:
      return _AlertConfig(
    ...
    case UgcSupportAlertType.logical:
      return _AlertConfig(
