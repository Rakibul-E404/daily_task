...
class _EditTaskScreenState extends State<EditTaskScreen> {
  ...
  void initState() {
    ...
    _selectedDateTime = widget.originalTask.dueDate;
  ...
  void _saveSubtask(int index) {
    _editableSubTasks[index] = UgcSubTask(
      ...
      completedAt: _editableSubTasks[index].completedAt,
    );
  ...
  void _saveTask() {
    for (int i = 0; i < _editableSubTasks.length; i++) {
      _editableSubTasks[i] = UgcSubTask(
        ...
        completedAt: _editableSubTasks[i].completedAt,
      );
    }
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              /// Task Due Date & Time
              Text('Task Due Date & Time', style: AppTextStyles.smallHeading),
              const SizedBox(height: 8),
              GestureDetector(
                onTap: () => _selectDateTime(context),
                child: Container(
