...
class TaskController extends GetxController {
  ...
  // Update task status (for Start button functionality)
// Update task status (for Start button functionality) - No full refresh
  Future<bool> updateTaskStatus(String taskId, String status) async {
    ...
    try {
      ...
      if (response.isSuccess || response.statusCode == 200) {
        // ✅ REMOVED: await refreshTasks();
        // Now the UI update is handled locally in the buildTaskCard
        isUpdatingStatus.value = false;
        return true;
      } else {
...
///
///
/// todo:: sharing with time passing with 'start' button
///
///
///
...
class TaskController extends GetxController {
  ...
  // Update task status (for Start/Complete button functionality)
